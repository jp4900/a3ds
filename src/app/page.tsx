    ...
    <>
      <main>
        ...
        <div>
          <HeroHighlight>
            ...
            <motion.h1
              ...
              className="text-xl px-4 md:text-3xl lg:text-4xl font-bold text-center text-neutral-700 dark:text-white max-w-4xl leading-relaxed lg:leading-snug mx-auto "
            >
        ...
        <div className=" bg-neutral-950 py-28">
          ...
          <p className="text-sm mb-4 px-4 md:text-lg lg:text-xl font-bold dark:text-neutral-300 leading-relaxed text-center">
  ...
  return (
    ...
    >
      ...
      <div className="text-lg font-bold mb-2 relative z-10 px-10">
        <div className="absolute left-0 inset-y-0 h-6 group-hover/feature:h-8 w-1 rounded-tr-full rounded-br-full bg-neutral-300 dark:bg-neutral-700 group-hover/feature:bg-blue-300 transition-all duration-200 origin-center" />
